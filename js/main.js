...
const translations = {
  zh: {
    ...
    'privacy.date': '2025年08月19日',
    'privacy.collect.title': '我们收集的信息',
    'privacy.collect.content': '为尊重您的隐私，Walltist 不会收集、存储或传输您设备上的任何个人信息或照片。所有照片处理和管理均在您的设备本地完成。',
    'privacy.photo.title': '相册访问',
    'privacy.photo.intro': '应用需要相册访问权限用于：',
    'privacy.photo.item1': '显示与整理您的照片',
    'privacy.photo.item2': '创建用于壁纸的自定义相册',
    'privacy.photo.item3': '允许您从网页保存图片',
    'privacy.photo.note': '所有相册访问均在您的设备本地进行。我们不会上传、共享或传输您的照片到任何外部服务器。',
    'privacy.camera.title': '相机访问',
    'privacy.camera.content': '相机权限仅用于扫描二维码以连接远程设备。此功能不会拍摄或存储任何照片或视频。',
    'privacy.network.title': '本地网络访问',
    'privacy.network.content': '本地网络权限用于启用远程访问功能，使您可以在同一 Wi-Fi 网络下从其他设备访问您的照片。该连接为点对点的本地连接，不经过任何外部服务器。',
    'privacy.storage.title': '数据存储',
    'privacy.storage.intro': '应用数据仅存储在您的设备本地，包括：',
    'privacy.storage.item1': '使用 iOS Photos 框架进行照片管理',
    'privacy.storage.item2': '使用 SwiftData 存储应用偏好与收藏',
    'privacy.storage.item3': '使用 App Groups 支持小组件功能',
    'privacy.storage.note': '我们不会将数据传输给任何外部服务器或第三方。',
    'privacy.thirdparty.title': '第三方服务',
    'privacy.thirdparty.content': '本应用未集成任何第三方分析、广告或数据收集服务。',
    'privacy.children.title': '儿童隐私',
    'privacy.children.content': '本应用适用于所有年龄段，不会收集任何儿童或成人的个人信息。',
    'privacy.changes.title': '本政策的变更',
    'privacy.changes.content': '我们可能会不时更新本隐私政策。任何变更将会在应用内及官网予以展示。',
    'privacy.contact.title': '联系我们',
    'privacy.contact.intro': '如对本隐私政策有任何疑问，请通过以下方式联系：',
    'privacy.contact.email': '邮箱：'
  },
  en: {
    ...
    'privacy.date': 'August 19, 2025',
    'privacy.collect.title': 'Information We Collect',
    'privacy.collect.content': 'Walltist is designed to respect your privacy. We do not collect, store, or transmit any personal information or photos from your device. All photo processing and management happens locally on your device.',
    'privacy.photo.title': 'Photo Access',
    'privacy.photo.intro': 'The app requires access to your photo library to:',
    'privacy.photo.item1': 'Display and organize your photos',
    'privacy.photo.item2': 'Create custom albums for wallpapers',
    'privacy.photo.item3': 'Allow you to save images from web sources',
    'privacy.photo.note': 'All photo access is handled locally on your device. We do not upload, share, or transmit your photos to any external servers.',
    'privacy.camera.title': 'Camera Access',
    'privacy.camera.content': 'Camera access is used solely for QR code scanning functionality to connect with remote devices. No photos or videos are captured or stored through this feature.',
    'privacy.network.title': 'Local Network Access',
    'privacy.network.content': 'Local network access is used to enable the remote sync feature, allowing you to access your photos from other devices on the same Wi-Fi network. This connection is direct and local — no data passes through external servers.',
    'privacy.storage.title': 'Data Storage',
    'privacy.storage.intro': 'All app data is stored locally on your device using:',
    'privacy.storage.item1': 'iOS Photos framework for photo management',
    'privacy.storage.item2': 'SwiftData for app preferences and favorites',
    'privacy.storage.item3': 'App Groups for widget functionality',
    'privacy.storage.note': 'No data is transmitted to external servers or third parties.',
    'privacy.thirdparty.title': 'Third-Party Services',
    'privacy.thirdparty.content': 'This app does not integrate with any third-party analytics, advertising, or data collection services.',
    'privacy.children.title': 'Children\'s Privacy',
    'privacy.children.content': 'Our app is suitable for all ages and does not collect any personal information from children or adults.',
    'privacy.changes.title': 'Changes to This Policy',
    'privacy.changes.content': 'We may update this privacy policy from time to time. Any changes will be reflected in the app and on our website.',
    'privacy.contact.title': 'Contact Us',
    'privacy.contact.intro': 'If you have any questions about this privacy policy, please contact us at:',
